...
以下の変更レポートを読み、エンジニアリング部長が変更内容を把握するための変更サマリーを作成すること。
部長は全Diffを読む時間はないが、変更の意図と影響範囲は把握したいと考えている。
</task>

<instructions>
関連する変更をグループ化し、変更クラスタ単位でまとめること。
各クラスタを以下の形式で記述すること。
...
バックエンドAPIの設計レビュアーとして回答すること。
以下の変更サマリーと変更レポートを読み、エンジニアリング部長が設計観点で確認すべき箇所を列挙すること。
