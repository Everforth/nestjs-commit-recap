...
import type { ModuleChange, ModuleConfig, ModuleImport, ModuleProvider, ModuleExport, ModuleController } from '../types/index.js';
...
export class ModuleAnalyzer extends BaseAnalyzer {
  async analyze(): Promise<ModuleChange[]> {
    ...
    for (const file of moduleFiles) {
      ...
      if (!this.isModuleFile(beforeContent) && !this.isModuleFile(afterContent)) {
        continue;
      }
